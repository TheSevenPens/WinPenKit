...
/// <summary>
/// Which pen input APIs a WPF application can offer.
/// </summary>
/// <remarks>
...
/// decides two things it has no view of -- whether <see cref="InputApi.WpfStylus"/> can be
/// offered at all, and whether <see cref="InputApi.WmPointer"/> can reach the
/// application.</para>
/// <para><see cref="InputApi.WmPointer"/> subclasses the window procedure, and WPF consumes
...
/// </remarks>
public static class WpfPenApis
{
    /// <summary>
    ...
    public static IReadOnlyList<InputApi> GetAvailable()
    {
        ...
        // WPF's stylus stack is part of the framework, so it is always available here.
        apis.Add(InputApi.WpfStylus);
        return apis;
    }
}
