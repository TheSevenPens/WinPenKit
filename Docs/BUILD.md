...
**Note:** Scribble.WinUI requires the Windows App SDK and may not build from the `dotnet` CLI due to PRI resource generation. Build it from Visual Studio instead.
