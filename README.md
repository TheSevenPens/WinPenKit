...
- [Tools/WintabContexts](Tools/WintabContexts/) — a window showing how many Wintab contexts are open. Not in the solution and not in any release; build it by hand.
